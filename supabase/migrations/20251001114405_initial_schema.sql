/*
  ...
  ## Tables Created:
  - users: User accounts with authentication, credits, and profile information
  - work_history: Service usage history for each user
  - blog_posts: Blog posts with SEO metadata
  - system_settings: System-wide configuration and service settings
  
  ## Security:
  - Row Level Security (RLS) enabled on all tables
  - Permissive policies for development (should be restricted in production)
  - UUID primary keys for all tables
  - Proper indexes for query performance
  
  ## Notes:
  - Default free trial credits: 100
  - Admin users get unlimited credits (999999)
  - Password reset tokens expire after 1 hour
  - Work history tracks all service usage with credit costs
*/
...
CREATE TABLE IF NOT EXISTS system_settings (
    ...
    service_credits_config JSONB DEFAULT '{}',
